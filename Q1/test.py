...
print "XOR person2 and masterkey1 into key variable " + ('{0:b}'.format(masterkey2).zfill(20))
...
#XOR person2 and masterkey3 into masterkey4 variable
masterkey4 = int('{0:b}'.format(masterkey3).zfill(20),2) ^ int(person3,2)
print "XOR person2 and masterkey3 into masterkey4 variable " + ('{0:b}'.format(masterkey4).zfill(20))
